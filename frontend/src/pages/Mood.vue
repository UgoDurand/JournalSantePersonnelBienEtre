...
export default {
  ...
  methods: {
    openMoodModal() {
      // Pré-remplir les données de la modal avec les valeurs actuelles
      this.moodData.mood = this.selectedMood;
      this.moodData.energy = this.selectedEnergy;
    ...
    saveMoodData() {
      console.log('Données d\'humeur modifiées:', this.moodData);
      ...
      alert('Données d\'humeur mises à jour avec succès !');
    },
    getMoodEmoji(mood) {
